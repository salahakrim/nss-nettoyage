...
<head>
  ...
  <title>Contactez-Nous - NSS NETTOYAGE Casablanca Maroc</title>
        ...
        <div class="col-lg-5 col-md-12 mb-0 mb-md-0">
          ...
          <div class="row text-center d-flex justify-content-center my-5">
            <div class="col-lg-3 col-md-6 mb-4">
              ...
              <p class="text-muted mb-0" style="font-size: small;">N25, 144 Rue Mohamed Smiha, 6ème étage, Casablanca Maroc</p>
            </div>
            <div class="col-lg-3 col-md-6 mb-4">
              <i class="fas fa-phone-alt fa-2x mb-4 grey-text"></i>
              <p class="text-muted mb-0" style="font-size: small;">(+212) 522486061</p>
            </div>
            <div class="col-lg-3 col-md-6 mb-4">
